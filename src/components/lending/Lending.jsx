    ...
    <>
        ...
        <section className="wrapper m-auto flex flex-wrap gap-10 justify-between pb-6 pt-6 md:pt-0">
            <div className="main-prim max-w-lg">
                ...
                <button className="main_btn text-sm md:text-base rounded-xl xs:rounded-lg w-48 md:w-64 h-12 md:h-16 xs:h-11 text-white uppercase">Присоединиться</button>
            </div>

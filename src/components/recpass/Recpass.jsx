    ...
    <div className='absolute inset-0 bg-[rgba(6,9,18,0.8)] w-full h-full'>
        <div className='absolute inset-x-2/4 translate-x-[-50%] translate-y-[50%] w-full sm:w-[540px] bg-[#F7F7FC] rounded-3xl px-10 pb-10 pt-5'>
            ...
            <form className='mt-[-10px]'>
                ...
                <div className='input-wrapper px-6 pt-5 bg-white rounded-xl h-[70px] shadow-[0px_25px_35px_0px_rgba(226,227,243,0.65)] mb-10'>
                    <input type="email" name="password" id='password'  placeholder=" " className='input input-label family-bold h-full w-full outline-none text-black'/>
                    <label htmlFor="password" className='label input-label text-grey'>Введите эл.почту от аккаунта</label>
                </div>

...
function Registration(props) {
  ...
  return (
    <div className='absolute inset-0 bg-[rgba(6,9,18,0.8)] w-screen h-screen'>
        <div className='absolute inset-x-2/4 translate-x-[-50%] translate-y-[10%] w-full sm:w-[540px] bg-[#F7F7FC] rounded-3xl px-10 pb-10 pt-5'>

...
function LendingPage() {
    const [registration, setClickedRegistration] = useState(null);
    ...
    return (
    <>
        <div className="bg-[url('/src/assets/images/lending_bg.png')] bg-no-repeat bg-cover bg-top min-h-screen h-full w-screen">   
        <Header/>
        <section className="wrapper m-auto flex flex-wrap gap-10 justify-between pb-6 pt-6 md:pt-0 mb-[10%]">

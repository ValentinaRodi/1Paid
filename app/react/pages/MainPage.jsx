import "./main.less";
import logo from "../../img/link-pin-plate.6d928d3b.svg"
import logoPic from "../../img/logo.7fb09570.svg";
import dots from "../../img/dots-1.82560447.svg";
...
import dota2 from "../../img/icon-dota2.c7d69ebf.png";
import picture4 from "../../img/game-card-bg-csgo.6235c5a2.png";
import csgo from "../../img/icon-csgo.b5c3b06d.png";
import picture5 from "../../img/game-card-bg-gta5.99ca99e5.png";
import gta5 from "../../img/icon-gta5.a916b090.png";
import picture6 from "../../img/game-card-bg-fortnite.6a6e51b5.png";
import fortnite from "../../img/icon-fortnite.2e93362c.png";
import picture7 from "../../img/game-card-bg-wot.f2291c2b.png";
import wot from "../../img/icon-wot.78a9639e.png";
import user from "../../img/avatar-example-bot.1e9be783.png";
import user2 from "../../img/avatar-example-1.efb6cc72.png";
import LeftMenu from "../components/leftMenu/LeftMenu";
import LeftBar from "../components/leftBar/LeftBar";
import FooterMenu from "../components/footerMain/FooterMain";
        ...
        <div className="layout-h px-9 pt-6 3xl:px-4 3xl:pt-4 lg:p-0">
          <div className="h-wrapper">
            <header className="flex items-center h-[100px]">
              ...
              <nav className="hnav flex gap-x-5 gap-y-5 flex-wrap mx-4 3xl:gap-x-2.5">
                <a
                  className="hnav-link  text-sm text-[#8A98B3] uppercase 3xl:text-xs lg:text-sm "
                  href="#"
                >
                  Главная
                </a>
                <a
                  className="hnav-link font-primary-bold text-sm text-[#8A98B3] uppercase 3xl:text-xs lg:text-sm "
                  href="#"
                >
                  Каталог
                </a>

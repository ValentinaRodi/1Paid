    ...
    return (
        ...
        <div className="layout-b pb-4 min-w-0 h-fit flex flex-wrap content-between">
            <div className="w-full layout-main h-full">
                <Title title='Техническая поддержка'/>
                <div className="sdb-main flex align-start w-full h-full gap-3 flex-col lg:flex-row">
                    ...
                    <div className="chat h-full sm:h-[843px] flex flex-col bg-white font-primary-med text-[#8FA0C3] w-full rounded-xl">
                        <div className="chat-head-wrapper flex justify-between items-center border-b border-solid border-[#EAEEF4] px-4 sm:px-6 py-4 sm:px-8 sm:py-6">
                            <div className="chat-head flex items-center gap-1 sm:gap-2.5">
                        ...
                        <div ref={bottomRef} className="chat-messages px-4 sm:px-6 py-4 sm:px-8 sm:py-6 h-[515px] overflow-hidden overflow-y-scroll">
                        ...
                        <div className="chat-form flex flex-col mt-4 gap-4 sm:gap-6">
                            ...
                            <div className="px-4 sm:px-6 w-full mb-4 sm:mb-5">
                                <div className="chat-input flex items-center bg-white font-secondary-med p-3 sm:p-4 border border-[#E4E9F4] rounded-xl w-full">
                                    <input className="chat-input-input text-black w-full h-full outline-none font-secondary-med placeholder:font-secondary-med placeholder:text-[#BAC9E5] text-[10px] sm:text-sm" placeholder="Вставьте содержимое товара..."/>
                                    <button className="chat-input-btn bg-inherit flex-shrink-0 flex justify-center items-center w-5 h-3 sm:w-[26px] sm:h-5 mr-2 sm:mr-6">
                                    ...
                                    <button className="chat-input-btn flex-shrink-0 flex justify-center items-center w-4 h-3 sm:w-[w-22px] sm:h-5">

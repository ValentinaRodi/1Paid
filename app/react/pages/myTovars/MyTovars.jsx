   ...
   const changeFormValue = (key, value) => {
    ...
    return (
        <div className="flex flex-wrap content-between layout-b pb-4 min-w-0 ">
            <div className="w-full layout-main relative">
                ...
                <div className="smt">
                    ...
                    <div className="smt-tab flex bg-white flex-wrap min-[430px]:flex-nowrap p-4 sm:p-6 rounded-lg justify-between items-center w-full mb-[32px] gap-2">
                        ...
                        <div className="relative smt-tab-actions flex items-center gap-3 ">
                            <div className="smt-tab-actions flex flex-wrap lg:flex-nowrap justify-start min-[430px]:justify-end items-center gap-1 sm:gap-3">
                                ...
                                <button className="smt-tab-btn btn flex justify-center items-center font-secondary-bold text-xs sm:text-sm text-white bg-gradient-primary rounded-full px-2 lg:px-4 h-[36px] min-w-[150px]">Поднять в ТОП
                                    <div className="smt-tab-btn-icon ml-[8px]">
                    ...
                    <div className="smt-main flex gap-x-3">
                        <div className="hidden min-[880px]:flex smt-filter flex-col items-center font-primary-bold min-w-[270px] max-w-[300px]">
                            ...
                            <span className="block w-full font-secondary-med text-[14px] text-[#A6B1C7]">Если вы хотите поднять в Топ какой то товар с определенного раздела ,то сначала вам нужно выбрать фильтр и далее нажать на поднять в топ ,если фильтр не выбран то вы поднимите все товары в топ</span>
                        </div>
                        <div className="pcg w-full">
                            <div className={`${cardsViewDiv} pcg-grid justify-items-center view-grid grid gap-3 grid-cols-1 min-[526px]:grid-cols-2 min-[1755px]:grid-cols-3`}>
                                {
                                    arrCard.length !== 0 ? 
                                        arrCard.map((card, index) => {
                                            return (cardsView ? 
                                                <CardGame key={uuid()} cliclShowDelModal={cliclShowDelModal} change='true' rank='4.8' id={index} new='1' seoName='Makmilan Gr-23' icon='product-preview-1.fcb96f91.png' name='Makmilan Gr-23' description='Оружие в идеальном состоянии, прямо из завода.' price='120.00'/> 
                                            : 
                                                <CardGameString key={uuid()} cliclShowDelModal={cliclShowDelModal} change='true' rank='4.8' id={index} new='1' seoName='Makmilan Gr-23' icon='product-preview-1.fcb96f91.png' name='Makmilan Gr-23' description='Оружие в идеальном состоянии, прямо из завода.' price='120.00'/> 
                                            )
                                        }) 
            ...
            {modalOpenUpTop && 
                (<div className='w-screen h-screen'>
                    <ModalUpTop closeModal={closeModal}/>
                </div>)
            }
        </div>
    );

        ...
        <div className="sps mt-11 2md:mt-5">
            <div
                ...
                <div className="sh-title">
                    <h2 className="sh-title-text font-secondary-bold text-2xl text-black 2md:text-xl">Настройки
                        профиля</h2>
                    <div className="sh-title-line mt-3 rounded-full w-9 h-1 2md:mt-2 bg-gradient-primary">
                    </div>
                </div>
            </div>
            <div className="sps-main flex w-full">
                <div className="sps-bar flex flex-col items-start mr-[80px]">
                    <div className="sps-bar flex flex-col items-start font-secondary-bold py-[16px]">
                        <div
                            ...
                            <img className="sps-avatar-pic w-full h-full object-cover"
                                 src="assets/images/avatar-example-5.00d4721a.png" alt="user"/>
                            <div
                ...
                <div className="sps-form flex flex-col w-full">
                    <div className="sps-fields grid grid-cols-2 gap-[24px] mb-[64px]">
                        <div className="input-wrapper flex flex-col font-secondary-bold text-black">
                            ...
                            <input className="bg-[#EAEBF8] p-[12px] text-sm border border-[#CED0E8] rounded-[4px]"
                                   type="text" placeholder={user.name} />
                        </div>
                        <div className="input-wrapper flex flex-col font-secondary-bold text-black">
                            <label className="input-label mb-[16px] text-[12px]">Секретное слово</label>
                            <input className="bg-[#EAEBF8] p-[12px] text-sm border border-[#CED0E8] rounded-[4px]"
                                   type="text" placeholder={user.secret_word} />
                        </div>
                        <div className="input-wrapper flex flex-col font-secondary-bold text-black">
                            <label className="input-label mb-[16px] text-[12px]">Пароль</label>
                            <input className="bg-[#EAEBF8] p-[12px] text-sm border border-[#CED0E8] rounded-[4px]"
                                   type="password" placeholder={user.password} value="" />
                        </div>
                        <div className="input-wrapper flex flex-col font-secondary-bold text-black">
                            <label className="input-label mb-[16px] text-[12px]">Почта</label>
                            <input className="bg-[#EAEBF8] p-[12px] text-sm border border-[#CED0E8] rounded-[4px]"
                                   type="email" placeholder={user.email} value="" />
                        </div>

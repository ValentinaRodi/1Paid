    ...
    return (
        <div className="spf-rating flex flex-col w-full sm:min-w-[316px]">
            ...
            <div className="spf-rating-info flex items-start">
                <div className="spf-rating-count font-secodary-bold font-bold text-black text-right text-3xl sm:text-[40px] mr-4 sm:mr-6">{props.rank} <span className="block font-secodary-bold font-bold text-xs sm:text-sm">из 5</span></div>

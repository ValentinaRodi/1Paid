...
function Registration(props) {
    ...
    const [errorAssept, setErrorAssept] = useState('');
    ...
    const handleSubmit = (e) => {
        ...
        if (name.length === 0 && !validateEmail(email) && !validatePassword(password) && !validatesecret_word(secret_word) && assept === false) {
    ...
    return (
        ...
        <div className='absolute z-20 inset-x-2/4 translate-x-[-50%] top-[8%] w-full sm:w-[540px] bg-[#F7F7FC] rounded-3xl px-10 pb-10 pt-5'>
            ...
            <button onClick={props.openAuthorization} className='w-full flex justify-center items-center gap-3 h-[70px] bg-[#ECECF7] hover:bg-[rgba(208,216,243,1)] rounded-xl text-base text-[#9595AE] uppercase'>войти

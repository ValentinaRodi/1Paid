...
import logo from "../../../../web/img/link-pin-plate.6d928d3b.svg";
import logoPic from "../../../../web/img/logo.7fb09570.svg";
import dots from "../../../../web/img/dots-1.82560447.svg";
    ...
    <div className="layout-sidebar ">
      <div className="cm w-full">
        <div className="cm-inner">
          <div className="cm-h w-full h-[150px] bg-no-repeat bg-center flex px-10 justify-between items-center 3xl:px-5 3xl:pt-5]">
          ...
          <div className="w-full h-10 mt-[-60px] shadow-[-15px_15px_65px_0px_rgba(126,70,247,0.45)]"></div>
          <div className="cm-b py-10 3xl:py-5">
            <div className="cm-container">
              <div className="tsc flex gap-4 p-3 flex-wrap border-[#E2E3F3A6] mb-10">
                <div className="tsc-item flex gap-x-2.5 items-center">
                  <button
                    className="btn btn-secondary w-[50px] h-[50px] rounded-full"
                    disabled=""
                  >
                    <svg
                      width="18"
                  ...
                  <div className="tsc-item-info">
                    <div className="tsc-item-value text-black text-sm font-bold">
                      181 924 365
                    </div>
                    <div className="tsc-item-label text-[#B2B9D1] mt-0.5 text-xs">
                      Куплено товаров
                    </div>
                  </div>
                </div>
                <div className="tsc-item flex gap-x-2.5 items-center">
                  <button
                    className="btn btn-primary w-[50px] h-[50px] rounded-full "
                    disabled=""
                  >
                    <svg
                      width="30"
              ...
              <div className="cm-nav mt-10 3xl:mt-8 xl:mt-6">
                <div className="navpin">
                  <a
                    className="navpin-item mt-[30px] first-of-type:mt-0 3xl:mt-4 shadow-[0px_15px_65px_0px_#DCE1F673]"
                    href="#"
                  >
                    <div className="navpin-plate">
                      <img className="navpin-plate-pic" src={logo} alt="dots" />
                      <img
                      ...
                      <img
                        ...
                        alt="dots"
                      />
                      <div className="navpin-plate-icon 2xl:mr-2">
                      <svg
                          width={30}
                          height={30}
                          viewBox="0 0 30 30"
                  ...
                  >
                    <div className="navpin-plate">
                      ...
                      <img
                        ...
                        alt="dots"
                      />
                      <div className="navpin-plate-icon 2xl:mr-3">
                        <svg
                          width={30}
                          height={30}
                          viewBox="0 0 30 30"

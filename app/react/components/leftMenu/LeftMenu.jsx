            ...
            <div className="cm-inner">
                ...
                <div className="cm-b mt-4">
                    <div className="cm-container">
                        ...
                        <div className="cm-nav mt-6 3xl:mt-10 xl:mt-8">
                            ...
                            <a onClick={sellProduct} className="navpin-item mt-4 first-of-type:mt-0 xl:mt-[30px]" href="#">
                            ...
                            <a onClick={goTab} className="navpin-item mt-4 first-of-type:mt-0 xl:mt-[30px]" href="#">
                                <div className="navpin-plate"><img className="navpin-plate-pic" src="/img/link-pin-plate.6d928d3b.svg" alt="dots"/>
                                    <img className="navpin-plate__dots-1" src="/img/dots-1.82560447.svg" alt="dots"/>
                                    <img className="navpin-plate__dots-2" src="/img/dots-1.82560447.svg" alt="dots"/>
                                    <div className="navpin-plate-icon">
                            ...
                            <a onClick={goHistory} className="navpin-item mt-4 first-of-type:mt-0 xl:mt-[30px]" href="#">
                            ...
                            <a onClick={goHistorySell} className="navpin-item mt-4 first-of-type:mt-0 xl:mt-[30px]" href="#">
                                <div className="navpin-plate">
                                    <img className="navpin-plate-pic" src="/img/link-pin-plate.6d928d3b.svg" alt="dots"/>
                                    <img className="navpin-plate__dots-1" src="/img/dots-1.82560447.svg" alt="dots"/>
                                    <img className="navpin-plate__dots-2" src="/img/dots-1.82560447.svg" alt="dots"/>
                ...
                <div className="cm-f pb-10">
                    <div className="cm-container flex flex-col items-center">
                        <a className="font-secondary-bold pl  rounded-full border-[1px] border-solid border-[#C0C2DC59] w-[160px] h-16 flex justify-center items-center hover:bg-slate-100" href="#">
                            <div className="ml-4 text-sm text-[#A1AEC8]">Выбор игры</div>
                        </a>
                        <div className="cm-f-bar mt-5 overflow-hidden flex justify-center items-center w-full h-16 rounded-full border-[1px] border-solid border-[#C0C2DC59]">
                            <a className="cm-f-bar-item h-full flex items-center gap-x-2 px-4 text-[#A1AEC8] hover:bg-slate-100" href="#">
                            ...
                            <div className="w-[1px] h-full flex-shrink-0 bg-[#C0C2DC59]"></div>
                            <a className="cm-f-bar-item h-full flex items-center gap-x-2 px-4 text-[#A1AEC8] hover:bg-slate-100" href="#">
                                <div className="cm-f-bar-item-icon flex-shrink-0">

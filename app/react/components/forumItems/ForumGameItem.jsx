...
function ForumGameItem(props) {
    ...
    const goGame = () => {
        ...
        (props.gameAll) ? null : navigate('/forum/Warface', { state: {titleGame:props.title } });
    };

    return (
        <div onClick={goGame} className={`${props.gameAll ? null : 'border-b border-solid border-[#E0E3F2]'} cursor-pointer flex flex-col min-[640px]:flex-row min-[950px]:flex-col min-[1100px]:flex-row justify-center min-[640px]:justify-between min-[950px]:justify-center gap-2 min-[640px]:gap-0 min-[950px]:gap-2 min-[1100px]:gap-0 min-[1100px]:justify-between  items-start min-[640px]:items-center min-[950px]:items-start min-[1100px]:items-center px-9 min-h-[100px] hover:bg-[#F6F9FF]`}>

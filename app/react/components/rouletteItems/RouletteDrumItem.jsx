...
function RouletteDrumItem(props) {
    ...
    return (
        <div className={`${props.bottom2} min-[466px]:${props.bottom} ${props.top2} min-[466px]:${props.top} ${props.left2} min-[466px]:${props.left} ocd-item-wrapper flex items-center w-full z-10 p-5 flex justify-center items-center absolute z-0`}>

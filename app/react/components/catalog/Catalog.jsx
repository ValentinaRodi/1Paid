            ...
            <div className='flex gap-2'>
                <div className='filtr bg-white rounded-[8px] min-w-[317px] p-6'>
                    ...
                    <div className="mb-6">
                        ...
                        <div class="">
                            <div class="form-item radio-btn nth-2 flex items-center gap-2 mb-2">
                                <input type="radio" name="option1" id="radio1" checked/>
                                <label for="radio1" className="font-secondary-bold text-bold text-xs">Онлайн</label>
                            </div>
                            <div class="form-item radio-btn nth-2 flex items-center gap-2">
                                <input type="radio" name="option1" id="radio2"/>
                                <label for="radio2" className="font-secondary-bold text-bold text-xs">Офлайн</label>
                            </div>
                        </div>
                    </div>
                    <div>
                                ...
                                gamesObj.map((card) => (
                                    ...
                                    <div key={uuid()} className="pc rounded-lg bg-white">
                                        ...
                                        <div className="pc-info">
                                            <div className="pc-title font-secondary-bold text-bold text-[13px] text-black">Аккаунт Warface</div>
                                            <div className="pc-subtitle mt-1 font-secondary-med text-xs text-[#A6B1C7] 3sm:text-[10px]">Оружие в идеальном состоянии, прямо из завода.</div>
                                        </div>
                                            ...
                                            <div className="pc-tbar-inner flex items-center gap-3 3sm:gap-1.5 3sm:flex-col 3sm:items-start">
                                                <div className="pc-source flex-shrink-0 w-11 h-11 3sm:w-10 3sm:h-10">
                                                    ...
                                                    <div className="pc-total-inf flex flex-wrap gap-x-[5px] font-secondary-bold text-xs 3sm:text-[10px]">
                                                        ...
                                                        <span className="text-black font-secondary-bold text-bold">120.00 <b>₽</b></span>
                                                    </div>

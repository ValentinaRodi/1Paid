            ...
            <div className='shadow-[0px_25px_35px_0px_#E2E3F3A6] w-full sm:w-[443px] bg-white rounded-lg px-6 pb-6'>
                ...
                <div className='mt-[-10px]'>
                    ...
                    <div className='flex justify-between gap-1 items-center'>
                        <button onClick={addBalance} className={`${bgColor ? 'shadow-[0px_4px_24px_0px_#A63DFD40] p-btn cursor-pointer' : 'bg-[#ABABAB] cursor-default'} px-0 text-base rounded-lg w-full h-[60px] text-white `}>Пополнить</button>
                    </div>
                </div>
            </div>
        </div>

        ...
        <div id='order'>
            {
                (arr.length !== 0) ? (
                    arr.map((item, index) => {
                        return (
                            <div key={uuid()} id={index}  className="py-3 sotl-item flex rounded-lg items-center gap-x-2 sm:gap-x-3 justify-between font-secondary-bold text-xs sm:text-sm text-black bg-white w-full min-h-[56px] px-4 sm:px-6 mb-[12px] ">
                                ...
                                <div className="flex justify-end items-center flex-col-reverse sm:flex-row gap-2 sm:gap-0 md:gap-2 h-full ">
                                    <div className="flex justify-center items-center gap-px md:gap-2 self-end flex-wrap md:flex-nowrap">
                                        ...
                                        <div className="timer-item relative flex-shrink-0 flex justify-center items-center ">
                                            <div className="circle-progress w-12 h-12 md:w-14 md:h-14" >
                                                <img src="/img/icon-circle-progress.svg" alt="circle-progress"/>
                                            </div>
                                            <div className="top-[-3px] left-[-6px] absolute flex flex-col items-center justify-center  w-full h-full z-[1] ml-px">
                                                <div className="timer-value font-primary-med text-center text-xs md:text-sm text-black leading-none mt-1.5">25</div>
                                                <div className="timer-value font-primary-bold text-center text-[7px] md:text-[9px] text-black leading-none">минут</div>
                                            </div>
                                        </div>
                                    </div>

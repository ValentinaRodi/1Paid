...
import arrow from "../../../img/icon-btn-12.svg";
import vk from "../../../img/icon-vk.svg";
import btnIcon2 from "../../../img/icon-btn-icon-2.svg";
import btnIcon3 from "../../../img/icon-btn-icon-3.svg";
import avatar from "../../../img/avatar-example-2.9f0c98b7.png";
import iconPlus from "../../../img/icon-plus-blue.a12eb4f0.svg";
import cardArrow from "../../../img/icon-pmc-card-arrow.svg";
import npNav from "../../../img/icon-np-nav-icon-1.svg";
import npNav2 from "../../../img/np-nav-icon-2.svg";
import npNav4 from "../../../img/icon-np-nav-icon-4.svg";
import npNav5 from "../../../img/icon-np-nav-icon-5.svg";
import npNav6 from "../../../img/icon-np-nav-icon-6.svg";
import npNav7 from "../../../img/icon-np-nav-icon-7.svg";
import npNav8 from "../../../img/icon-np-nav-icon-8.svg";
import npNav9 from "../../../img/icon-np-nav-icon-9.svg";
import logoDots from "../../../img/dots-1.82560447.svg";
import logoDots2 from "../../../img/logo.7fb09570.svg";
import btnOrange from "../../../img/btn-orange.svg";
import linkPin from "../../../img/link-pin-plate.6d928d3b.svg";
import navpinPlate from "../../../img/icon-navpin-plate-icon.svg";
import navpinPlate2 from "../../../img/icon-navpin-plate-icon-2.svg";
import navpinPlate3 from "../../../img/icon-navpin-plate-icon-3.svg";
import navpinPlate4 from "../../../img/icon-navpin-plate-icon-4.svg";
import lk from "../../../img/icon-lk.svg";

...
//import instagram from "../../../img/icon-inst-grey.62109207.svg";
//import discord from "../../../img/icon-discord-grey.c77ff220.svg";
//import vk from "../../../img/icon-vk-grey.349c1aa3.svg";
//import youtube from "../../../img/icon-yt-grey.4134affa.svg";
        ...
        <div className="footer-soc flex gap-5 2md:flex-wrap 2md:justify-center">
          <a className="shrink-0 leading-none duration-200" href="#">
            <img
              ...
              src="../../../img/icon-inst-grey.62109207.svg"
              alt="disrcod"
            />
          </a>
          <a className="shrink-0 leading-none duration-200" href="#">

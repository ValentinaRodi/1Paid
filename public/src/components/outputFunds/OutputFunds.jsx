import  './outputFunds.css'; 

function OutputFunds() {
 
  return (
    <div className='absolute inset-0 bg-[rgba(6,9,18,0.8)] w-full h-full'>
        <div className='shadow-[0px_25px_35px_0px_#E2E3F3A6] absolute inset-x-2/4 translate-x-[-50%] translate-y-[5%] w-full sm:w-[443px] bg-white rounded-lg px-6 pb-6'>
            ...
            <form className='mt-[-10px]'>
                ...
                <label htmlFor="bankCard" className='block family-bold text-black font-bold text-xs mb-4'>Способ вывода</label>
                <div className='mb-5 rounded mb-2 border-solid border-[#CED0E840] bg-[linear-gradient(0deg,rgba(206,208,232,0.25),rgba(206,208,232,0.25)),linear-gradient(0deg,#EAEBF8,#EAEBF8)] shadow-[0px_4px_35px_0px_#8E91B026] h-12 w-full'>
                    <select name="bankCard" id='bankCard' className='appearance-none bg-inherit form-select family-bold text-[13px] px-4 h-12 w-full outline-none text-black'>
                        <option value="VISA/MASTERCARD">Банковская карта VISA/MASTERCARD</option>
